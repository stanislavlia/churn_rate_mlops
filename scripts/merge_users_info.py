...
@click.option("--agg_logs_path", help="Path to aggregated logs of users that we will merge with")
@click.option("--agg_transactions_path", help="Path to aggregated transactions")
...
def merge_users_data(members_path, 
    ...
    members_logs_transactions= members_logs_df.join(agg_transactions_df, on="msno", how="left")
